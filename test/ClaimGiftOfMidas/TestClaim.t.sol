...
contract TestClaim is Test {
    ...
    function testCanWinLegendaryPrize() public {
    ...
    function testCanWinCommonPrize() public {
        vrfConsumer.requestRandomWords(2, 100000);
        uint256 requestId = vrfConsumer.s_requestId();
        vrfCoordinator.fulfillRandomWords(requestId, address(vrfConsumer));
        vrfConsumer.generateWinners();
    ...
    function testBulkClaim() public {
        ...
        vrfConsumer.bulkClaimPrizes(tokenIds);
        assertTrue(mockERC721.ownerOf(0) == userTwo);
        assertTrue(mockERC721.ownerOf(1) == userTwo);
        assertTrue(mockERC1155.balanceOf(userTwo, 0) == 9);
        assertTrue(mockERC1155N2.balanceOf(userTwo, 2) == 9);
    }
